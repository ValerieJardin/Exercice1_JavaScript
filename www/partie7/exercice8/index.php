...
<html>
    ...
    <body>
        ...
        if (isset($_POST['gender']) && isset($_POST['lastname']) && isset($_POST['firstname']) && isset($_FILES['myFile']) && $_FILES['myFile']['error'] == 0) {
            ...
            $extentionAccepted = array('pdf');
            if (in_array($fileType, $extentionAccepted)) {
                echo 'Ton fichier ' . basename($_FILES['myFile']['name']) . ' est au format pdf. ';
            } else {
                echo 'Bien que nous ayons reçu ton fichier nous ne l\'acceptons pas car il n\'est pas en format pdf.';
            }
            ?>
            <br/>
            <?php
